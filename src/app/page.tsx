        ...
        <section className="pb-8 sm:pb-12 lg:pb-20" id="about-us">
          <div className="rounded-[1.2rem] border border-[#dde2ea] bg-white p-4 shadow-[0_10px_30px_rgba(0,0,0,0.03)] sm:rounded-[1.6rem] sm:p-6 sm:shadow-[0_15px_40px_rgba(0,0,0,0.04)] lg:rounded-[2rem] lg:p-10 lg:shadow-[0_18px_45px_rgba(0,0,0,0.05)]">
            ...
            <div className="mt-6 max-w-3xl space-y-4 text-xs leading-6 text-[#434b59] sm:mt-8 sm:space-y-6 sm:text-base sm:leading-8 lg:text-lg">
              <p>
                TORQ was born from a simple question: why should premium Commander software feel out of reach? I saw a familiar problem at Commander tables: the tools that make game nights smoother often sit behind pricing that many players can&apos;t justify. Life totals are a solved problem. A polished interface, reliable controls, and thoughtful table experience should be accessible to the whole community.
              </p>

              <p>
                What we&apos;re selling is the software. It brings the features Commander players expect, plus the improvements we&apos;re shaping in public with you. The hardware is simple: a 1.85-inch intelligent rotary control screen with ESP32-S3 core, openly available on <a href="https://s.click.aliexpress.com/e/_c3XyGxvD" target="_blank" rel="noopener noreferrer" className="text-[#1434d6] underline hover:text-[#091aa0]">AliExpress</a> at an accessible cost, with free shipping and delivery in under a week. This transparency is intentional. We&apos;re not hiding the bill of materials or pretending we engineered something magical. We took accessible components and built software that makes Commander nights better. That&apos;s the value. That&apos;s what you&apos;re investing in.
              </p>
