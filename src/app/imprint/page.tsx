  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#06090d] text-[#e6edf6]">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-[1280px] flex-col px-4 pt-4 pb-12 sm:px-6 lg:px-8">
        ...
        {/* Mobile Menu */}
        {mobileMenuOpen && (
          <div className="bg-[#101722] border-b border-[#1e2c3d] px-3 py-3 md:hidden">
            <nav className="flex flex-col gap-3">
              {leftNav.map((item) => (
                <a
                  ...
                  className="text-sm font-medium uppercase tracking-[0.12em] text-[#11c9ff] transition hover:text-[#245dce]"
                >
                  {item}
                </a>
              ))}
        ...
        <article className="max-w-3xl mx-auto mt-12">
          <h1 className="text-4xl font-extrabold tracking-tight text-[#e6edf6] mb-8">Imprint</h1>

          <section className="bg-[#101722] rounded-[2rem] border border-[#1e2c3d] p-6 shadow-[0_18px_45px_rgba(0,0,0,0.3)] sm:p-8 mb-8 space-y-8">
            {/* Business Information */}
            <div>
              <h2 className="text-xl font-bold text-[#11c9ff] mb-4">Business Information</h2>
              <div className="space-y-2 text-[#b9c5d8]">
                <p>
            ...
            {/* Contact Details */}
            <div>
              <h2 className="text-xl font-bold text-[#11c9ff] mb-4">Contact Details</h2>
              <div className="space-y-2 text-[#b9c5d8]">
                <p>
                  <strong>Email:</strong>{" "}
                ...
                <p>
                  ...
                  <a href="https://torq-lab.com" className="text-[#11c9ff] hover:text-[#245dce]">
                    torq-lab.com
                  </a>
                </p>
              </div>
            ...
            {/* Responsibility */}
            <div>
              <h2 className="text-xl font-bold text-[#11c9ff] mb-4">Responsibility for Content</h2>
              <p className="text-[#b9c5d8] leading-7">
              ...
              <p className="text-[#b9c5d8] leading-7 mt-4">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#11c9ff] mb-4">Intellectual Property</h2>
              <p className="text-[#b9c5d8] leading-7">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#11c9ff] mb-4">Disclaimer of Warranties</h2>
              <p className="text-[#b9c5d8] leading-7">
            ...
            {/* Data Protection */}
            <div>
              <h2 className="text-xl font-bold text-[#11c9ff] mb-4">Data Protection & Privacy</h2>
              <p className="text-[#b9c5d8] leading-7">
            ...
            <div>
              <h2 className="text-xl font-bold text-[#11c9ff] mb-4">Questions or Concerns</h2>
              <p className="text-[#b9c5d8] leading-7">
          ...
          {/* Footer Links */}
          <div className="border-t border-[#1e2c3d] pt-8 flex gap-6 flex-wrap justify-center text-sm">
            <Link href="/" className="text-[#11c9ff] hover:text-[#245dce]">
              Home
            </Link>
            <Link href="/refund-policy" className="text-[#11c9ff] hover:text-[#245dce]">
              Refund Policy
            </Link>
            <a href="mailto:support@torq-lab.com" className="text-[#11c9ff] hover:text-[#245dce]">
              Contact
          ...
          <p className="text-center text-xs text-[#b9c5d8] mt-8">
